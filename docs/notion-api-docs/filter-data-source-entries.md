...
Here is the same query using the 
JavaScript
```
...
> ## 👍
> The filter object mimics the data source 
...
Field | Type | Description | Example value  
---|---|---|---  
`after` |  `string` ( | The value to compare the date property value against.  
...
`before` |  `string` ( | The value to compare the date property value against.  
...
`"2021-10-15T12:00:00-07:00"`  
`equals` |  `string` ( | The value to compare the date property value against.  
...
`on_or_after` |  `string` ( | The value to compare the date property value against.  
...
`"2021-10-15T12:00:00-07:00"`  
`on_or_before` |  `string` ( | The value to compare the date property value against.  
