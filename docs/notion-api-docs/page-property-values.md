...
Field | Type | Description | Example value  
---|---|---|---  
`created_time` |  `string` ( | The date and time that the page was created.  
...
Field | Type | Description | Example value  
---|---|---|---  
`end` |  `string` ( | (Optional) A string representing the end of a date range.  
  
If the value is `null`, then the date value is not a range. | `"2020-12-08T12:00:00Z"`  
`start` |  `string` ( | A date, with an optional time.  
...
Field | Type | Description | Example value  
---|---|---|---  
`last_edited_time` |  `string` ( | The date and time that the page was last edited.  
...
> ## 📘
> The `verification` property is only available for pages that are part of a [wiki database](https://developers.notion.com/docs/working-with-databases#wiki-databases). To learn more about wiki databases and verifying pages, see our 
Field | Type | Description | Example value  
---|---|---|---  
...
`date` | Object or `null` | If the page is verified, the date object will include the date the verification started (`start`). If an expiration date is set for the verification, an end date (`end`) will be included. ( | Refer to the example response objects below.  
#### 
...
### [](https://developers.notion.com/reference/page-property-values#unsupported-properties)
