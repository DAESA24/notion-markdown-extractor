...
### [](https://developers.notion.com/reference/intro#json-conventions)
  ...
  * Temporal values (dates and datetimes) are encoded in `2020-08-12T02:12:33.231Z`) while dates will include only the date (`2020-08-12`)
...
Samples requests and responses are shown for each endpoint. Requests are shown using the Notion 
...
### [](https://developers.notion.com/reference/intro#how-to-send-a-paginated-request)
  1. Send an initial request to the 
