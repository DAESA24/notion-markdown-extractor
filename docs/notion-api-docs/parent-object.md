...
## [](https://developers.notion.com/reference/parent-object#the-unfurl-attribute-object)
...
### [](https://developers.notion.com/reference/parent-object#inline-sub-type-objects)
...
#### 
`dev` attribute
[](https://developers.notion.com/reference/parent-object#the-dev-attribute)
...
### [](https://developers.notion.com/reference/parent-object#embed-sub-type-child-objects)
You can use the `embed` sub-type object to add rich content like JPGs, GIFs, or iFrames to your Link Preview. 
![1228](https://files.readme.io/d482801-embed.png)
...
### 
`section` value
[](https://developers.notion.com/reference/parent-object#the-section-value)
The `section` value of an unfurl attribute object defines where an attribute is rendered in the Link Preview or Mention. 
![1378](https://files.readme.io/121dcba-sections_lp.png)
The sections of a Link Preview
![926](https://files.readme.io/1de6886-sections_mention.png)
